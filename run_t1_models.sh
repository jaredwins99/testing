...
# tmux new-session -d -s A1_v_o_m_c "Rscript model_starters/proportion/A1_vegetarian_on_mpbamod_count.R 2>&1 | tee logs/A1_v_o_m_c.log"
# tmux new-session -d -s A1_v_o_m_p "Rscript model_starters/proportion/A1_vegetarian_on_mpbamod_prop.R 2>&1 | tee logs/A1_v_o_m_p.log"
# tmux new-session -d -s A1_v_o_v_c "Rscript model_starters/proportion/A1_vegetarian_on_vegan_count.R 2>&1 | tee logs/A1_v_o_v_c.log"
# tmux new-session -d -s A1_v_o_v_p "Rscript model_starters/proportion/A1_vegetarian_on_vegan_prop.R 2>&1 | tee logs/A1_v_o_v_p.log"
# tmux new-session -d -s A1_v_o_vn_c "Rscript model_starters/proportion/A1_vegetarian_on_vegetarian_count.R 2>&1 | tee logs/A1_v_o_v_c.log"
# tmux new-session -d -s A1_v_o_vn_p "Rscript model_starters/proportion/A1_vegetarian_on_vegetarian_prop.R 2>&1 | tee logs/A1_v_o_v_p.log"
