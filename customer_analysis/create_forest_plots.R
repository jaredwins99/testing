...
OUTPUT_DIR <- "customer_analysis/forest_plots"
OUTPUT_DIR_LOG <- "customer_analysis/forest_plots_log"
...
create_A5_forest <- function() {
  ...
  files <- list.files("customer_analysis/results_exposures", pattern = "^A5_", full.names = TRUE)
...
create_A6_forest <- function() {
  ...
  files <- list.files("customer_analysis/results_exposures", pattern = "^A6_", full.names = TRUE)
  df <- load_exposure_data(files) %>% to_rate_ratios()
