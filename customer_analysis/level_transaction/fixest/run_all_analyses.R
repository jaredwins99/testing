  ...
  for (rest in restaurants) {
    ...
    if (!is.null(result)) {
      ...
      restaurant_file <- file.path(
        "customer_analysis/transaction_level/fixest/results_other",
...
run_all <- function() {
  ...
  message("  Exposures: customer_analysis/transaction_level/fixest/results_exposures/")
  message("  Full results: customer_analysis/transaction_level/fixest/results_other/")
  message("=================================================\n")
