...
non_weather <- paste0("![](", "modeling_results/gs_optimal_", location_ids, "_pred_plot.png)")
weather <- paste0("![](", "modeling_results/gs_optimal_weather_", location_ids, "_pred_plot.png)")
...
df <- data.frame("Non-weather Image" = non_weather,
