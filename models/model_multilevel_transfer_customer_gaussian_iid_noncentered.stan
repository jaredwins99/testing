// model_multilevel_transfer_customer_gaussian_iid_noncentered.stan
// 
// The NON-CENTERED customer Gaussian IID model, as it stood at commit
// c0c8d560 (2026-03-10). Replaced in place by the centered version at
// bdca7845 (2026-03-16).
// 
// Produced 13 published fits: 8 in finalized_redone_trunc_cp and 5 in
// finalized_uncontaminated2 (the A6 customer-targeted day models that ran on
// the second machine under CmdStan 2.36.0).
// 
