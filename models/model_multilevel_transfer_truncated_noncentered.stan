...
// 
// The NON-CENTERED version of the truncated model, as it stood at commit
// e28ffe8c (2026-02-23). Parameters are z_beta_intercept / z_beta_random /
// z_alpha_random / z_delta_random / z_phi_log.
// 
// This is the model that produced all 52 finalized_redone_trunc fits. The
// 2026-03-04 refactor (33e67db7) replaced it in place with the centered
// parameterization now in model_multilevel_transfer_truncated.stan -- that
// switch is what the _cp era name refers to. Kept here because those fits
// cannot be reproduced against the current file.
// 
