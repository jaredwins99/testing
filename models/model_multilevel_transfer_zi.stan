data {
  ...
  real<lower=0> z_pi_scale;            // Zero-inflation deviates
}
...
model {
  ...
  // Zero-inflation
  sigma_pi_logit ~ student_t(3, 0, sigma_pi_logit_scale);   // Prior on between-restaurant SD
  ...
  // Zero-inflation
  z_pi_logit ~ normal(0, z_pi_scale);                   // Per-restaurant deviates
