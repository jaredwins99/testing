...
saveRDS(results, here::here("model_scripts", "simulations", "simulate_simple_results.rds"))
cat("Results saved to model_scripts/simulations/simulate_simple_results.rds\n")
