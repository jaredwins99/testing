...
run_prop <- function(outcome, exposure, restaurants_to_model = c(
            ...
            'L69HYJ4Y3TR91',
            'ED5J990H5VAZT',
            'W8T41JZK0ZMEP'), directory="finalized", adapt_delta = .85, max_treedepth = 12, thin = 1, apply_truncation = FALSE, replot_only = FALSE) {
    run_ingarch(
...
# A3
run_its <- function(outcome, restaurants_to_model = c(
            #'VLZX7K2M9QD4T',
            'SRQS8F7JWA9MZ',
            '2HRX9P6HKXA8V',
            #'JHDN7CF1C03X5',
...
# A4
run_its_targeted <- function(outcome, restaurants_to_model, extra_price_predictor, directory="finalized", adapt_delta = .85, max_treedepth = 12, thin = 1, apply_truncation = FALSE, replot_only = FALSE) {
    run_ingarch(
        data_file = file.path("its","finalized.parquet"),
        directory = directory,
...
# A6
run_customer_targeted <- function(outcome, restaurants_to_model, extra_price_predictor, directory="finalized", adapt_delta = .85, max_treedepth = 10, iter_warmup = 1500, iter_sampling = 2000, thin = 1, apply_truncation = FALSE, replot_only = FALSE) {
    run_gaussian_iid(
        data_file = file.path("customer","finalized_transactions_customers.parquet"),
        directory = directory,
...
# A1 T2
run_prop_t2 <- function(outcome, exposure, restaurants_to_model=c(
            # Tier 1
...
# A4 T2
run_its_targeted_t2 <- function(outcome, restaurants_to_model, extra_price_predictor, directory="finalized", adapt_delta = .85, max_treedepth = 12, iter_warmup = 1500, iter_sampling = 2000, thin = 1, apply_truncation = FALSE, replot_only = FALSE) {
    run_ingarch(
        data_file = file.path("its","finalized.parquet"),
        directory = directory,
...
# A6 T2
run_customer_targeted_t2 <- function(outcome, restaurants_to_model, extra_price_predictor, directory="finalized", adapt_delta = .85, max_treedepth = 10, iter_warmup = 1500, iter_sampling = 2000, thin = 1, apply_truncation = FALSE, replot_only = FALSE) {
    run_gaussian_iid(
        data_file = file.path("customer","finalized_transactions_customers.parquet"),
        directory = directory,
