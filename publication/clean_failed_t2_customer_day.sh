...
set -u
ROOTS=(
  "$SCRATCH/model_fits/finalized_redone_trunc_cp/t2_customer_gaussian_iid_day"
  "$SCRATCH/model_fits/finalized_redone_trunc_cp/t2_customer_targeted_gaussian_iid_day"
)
