...
# into D:/HSFL/Restaurant Sales/testing/model_fits/finalized_redone_trunc_cp/t2_proportion/total/
...
REMOTE_DEST="$REMOTE_USER@$REMOTE_HOST:D:/HSFL/Restaurant Sales/testing/model_fits/finalized_redone_trunc_cp/t2_proportion/total/"
