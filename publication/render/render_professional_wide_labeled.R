...
#
# Output directories:
#   publication/forest_plots/wide_labeled/t1_adj/   (6 PDFs)
#   publication/forest_plots/wide_labeled/t2_adj/   (9 PDFs, T2 A1/A3 split)
#
# CLI arguments:
...
LABELED_DIR_T1 <- "publication/forest_plots/wide_labeled/t1_adj"
LABELED_DIR_T2 <- "publication/forest_plots/wide_labeled/t2_adj"
...
SOURCE_DIR_T1 <- "publication/forest_plots/total_adjusted/t1_recentered_wide_lbl"
SOURCE_DIR_T2 <- "publication/forest_plots/total_adjusted/t2_recentered_wide_lbl"
...
#   publication/forest_plots/total_adjusted/t1_recentered_wide/
#   publication/forest_plots/total_adjusted/t2_recentered_wide/
