...
SOURCE_DIR_T1 <- "archive/forest_plots/total_adjusted/t1_sorted_recentered_wide_fixed"
SOURCE_DIR_T2 <- "archive/forest_plots/total_adjusted/t2_sorted_recentered_wide_fixed"
