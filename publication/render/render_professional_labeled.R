...
#
# Output directories:
#   publication/forest_plots/professional_labeled/t1_adj/   (6 PDFs)
#   publication/forest_plots/professional_labeled/t2_adj/   (6 PDFs)
#
# CLI arguments:
...
LABELED_DIR_T1 <- "publication/forest_plots/professional_labeled/t1_adj"
LABELED_DIR_T2 <- "publication/forest_plots/professional_labeled/t2_adj"
...
SOURCE_DIR_T1 <- "publication/forest_plots/total_adjusted/t1"
SOURCE_DIR_T2 <- "publication/forest_plots/total_adjusted/t2"
...
#   publication/forest_plots/total_adjusted/t1/
#   publication/forest_plots/total_adjusted/t2/
