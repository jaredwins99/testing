...
# ----------------------------------------------------------------------
# Self-contained renderer for the publication-quality (PDF only)
# forest plots for both T1 and T2 adjusted analyses (A1–A6).
#
# Output directories:
#   publication/forest_plots/professional/t1_adj/   (6 PDFs)
#   publication/forest_plots/professional/t2_adj/   (6 PDFs)
#
...
#
# Examples:
#   Rscript render_professional.R          # render everything
#   Rscript render_professional.R A3       # only A3 for both tiers
#   Rscript render_professional.R ALL T2   # all analyses, T2 only
#   Rscript render_professional.R A1 T1    # A1 for T1 only
# ----------------------------------------------------------------------
...
PROFESSIONAL_DIR_T1 <- "publication/forest_plots/professional/t1_adj"
PROFESSIONAL_DIR_T2 <- "publication/forest_plots/professional/t2_adj"
...
SOURCE_DIR_T1 <- "publication/forest_plots/total_adjusted/t1_sorted"
SOURCE_DIR_T2 <- "publication/forest_plots/total_adjusted/t2_sorted"
...
copy_pdfs <- function(stems, src_dir, dst_dir, tier_label) {
  copied  <- character(0)
  missing <- character(0)
  cat("\n[render_professional] Copy PDFs ->", dst_dir, "\n")
  for (stem in stems) {
...
# -------------------------------------------------------------------
# Step 3: copy PDFs into professional/ dirs.
# -------------------------------------------------------------------
