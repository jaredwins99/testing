...
Currently **130 reported** cells and **16 suppressed**:

- fewer than two contributing restaurants — 15
...
>
> ```
> Rscript publication/scripts/extract_rr_95ci.R
> ```
...
|---|---|---|---|
| Vegan | Vegan | 1.108 [1.004, 1.347] | 1.079 [0.628, 2.007] |
| Vegetarian | Vegetarian | 1.090 [0.899, 1.342] | 1.453 [1.045, 2.404] |
...
| Outcome | Exposure | Level change | Slope change |
|---|---|---|---|
| Vegan | Vegan | 1.230 [0.835, 1.620] | 1.111 [0.998, 1.341] |
| Vegetarian | Vegetarian | 1.092 [0.873, 1.614] | 1.128 [1.007, 1.267] |
