...
\node[subhead] at ($(A1c1)+(0,0.40)$) {Exposure intensity};
\node[subhead] at ($(A1c2)+(0,0.40)$) {Exposure type};
...
\node[minicross, anchor=south] at ($(A1c12mid |- A1yref)+(0.35,0)$) {$\times$ crossed};
...
\node[subhead] at ($(A2c1)+(0,0.40)$) {Exposure intensity};
...
\node[subhead] at ($(A3c1)+(0,0.40)$) {Exposure intensity};
...
\node[subhead] at ($(A4c1)+(0,0.40)$) {Exposure intensity};
