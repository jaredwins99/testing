...
\begin{tikzpicture}[
  ...
  cell/.style        = {draw=black!55, thick, rounded corners=2pt,
                        minimum width=115mm, minimum height=50mm,
                        anchor=north west},
...
\node[cell] (A3) at (0.0,  -5.5) {};
\node[cell] (A4) at (12.5, -5.5) {};
...
\node[minicross, anchor=south]
  at ($(A1c1box.east)!0.5!(A1c2r2.west)+(0,0.10)$) {$\times$ fully crossed};
\node[minicross, anchor=south]
  at ($(A1c2box.east)!0.5!(A1arr2end)+(0,0.10)$) {$\times$ fully crossed};

\node[countline] at ($(A1.north west)+(0.30,-3.90)$) {36 exposure--outcome pairings};
\node[countline] at ($(A1.north west)+(0.30,-4.25)$) {18 primary outcomes};
\node[countline] at ($(A1.north west)+(0.30,-4.60)$) {36 pooled estimates};
...
\node[minicross, anchor=south]
  at ($(A2c1box.east)!0.5!(A2arr1end)+(0,0.10)$) {$\times$ fully crossed};

\foreach \i in {1,...,6} {
  \draw[minimatch] (A2c2r\i.east) -- (A2c3r\i.west);
}
\node[minicross, anchor=south]
  at ($(A2c2r1.east)!0.5!(A2c3r1.west)+(0,0.10)$) {1-to-1 matched};

\node[countline] at ($(A2.north west)+(0.30,-3.90)$) {10 exposure--outcome pairings};
\node[countline] at ($(A2.north west)+(0.30,-4.25)$) {10 primary outcomes};
\node[countline] at ($(A2.north west)+(0.30,-4.60)$) {10 pooled estimates};
...
\node[minicross, anchor=south]
  at ($(A3c1box.east)!0.5!(A3c2r2.west)+(0,0.10)$) {$\times$ fully crossed};
\node[minicross, anchor=south]
  at ($(A3c2box.east)!0.5!(A3arr2end)+(0,0.10)$) {$\times$ fully crossed};

\node[countline] at ($(A3.north west)+(0.30,-3.90)$) {6 exposure--outcome pairings};
\node[countline] at ($(A3.north west)+(0.30,-4.25)$) {3 primary outcomes};
\node[countline] at ($(A3.north west)+(0.30,-4.60)$) {12 pooled estimates};
...
\node[minicross, anchor=south]
  at ($(A4c1box.east)!0.5!(A4arr1end)+(0,0.10)$) {$\times$ fully crossed};

\foreach \i in {1,...,6} {
  \draw[minimatch] (A4c2r\i.east) -- (A4c3r\i.west);
}
\node[minicross, anchor=south]
  at ($(A4c2r1.east)!0.5!(A4c3r1.west)+(0,0.10)$) {1-to-1 matched};

\node[countline] at ($(A4.north west)+(0.30,-3.90)$) {3 exposure--outcome pairings};
\node[countline] at ($(A4.north west)+(0.30,-4.25)$) {3 primary outcomes};
\node[countline] at ($(A4.north west)+(0.30,-4.60)$) {6 pooled estimates};
...
\draw[arr]
  ($(A1.west) + (-1.05, 1.30)$) -- ($(A3.west) + (-1.05,-1.30)$);

% =============================================================
% Within-customer sensitivity (one-off, branching from A3 + A4)
% =============================================================
\node[ccell] (CC) at (5.2, -11.5) {};
