...
\coordinate (A1yref)    at ($(A1.north west)+(0,-1.00)$);
...
\coordinate (A2yref)   at ($(A2.north west)+(0,-1.00)$);
...
\node[minicross, anchor=south] at (A2c23mid |- A2yref) {1-to-1 matched};
...
\coordinate (A3yref)   at ($(A3.north west)+(0,-1.00)$);
...
\coordinate (A4yref)   at ($(A4.north west)+(0,-1.00)$);
...
% Match the shared y so this label aligns horizontally with the x crossed.
\node[minicross, anchor=south]
  at ($(A4c23mid |- A4yref)+(-0.25,0)$) {1-to-1 matched};
