...
\node[miniitem] (A2c2r5) at ($(A2c2)+(0,-1.52)$) {Egg Analogs};
...
\node[miniitem] (A2c3r5) at ($(A2c3)+(0,-1.52)$) {Egg Sales};
...
\node[miniitem] (A3c2r2) at ($(A3c2)+(0,-0.38)$) {Vegan Items};
\node[miniitem] (A3c2r3) at ($(A3c2)+(0,-0.76)$) {Vegetarian Items};
...
\coordinate (A3c12mid) at ($(A3c1box.east)!0.5!(A3c2r2.west)$);
...
\node[miniitem] (A4c2r4) at ($(A4c2)+(0,-1.14)$) {Chicken Analogs};
\node[miniitem] (A4c2r5) at ($(A4c2)+(0,-1.52)$) {Egg Analogs};
\node[miniitem] (A4c2r6) at ($(A4c2)+(0,-1.90)$) {Dairy Analogs};
...
\node[miniitem] (A4c3r4) at ($(A4c3)+(0,-1.14)$) {Chicken Sales};
\node[miniitem] (A4c3r5) at ($(A4c3)+(0,-1.52)$) {Egg Sales};
\node[miniitem] (A4c3r6) at ($(A4c3)+(0,-1.90)$) {Dairy Sales};
