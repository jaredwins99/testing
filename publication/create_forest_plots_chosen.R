# Forest Plot Generation Script - CHOSEN VERSION
...
OUTPUT_DIR <- "publication/forest_plots/forest_plots_chosen"
...
extract_mu_gamma <- function(model_path, gamma_index = 1) {
  # Use 95% CI helper (computes q2.5 and q97.5 from samples)
...
cat("========================================\n")
cat("Forest Plot Generation - CHOSEN VERSION\n")
cat("========================================\n")
