...
#SBATCH --array=1-10
#SBATCH --output=archive/logs/stan_t1_a2_%A_%a.out

# Tier 1 A2 re-fit after the clip review -- 10 models (5 categories x count/presence).
#
