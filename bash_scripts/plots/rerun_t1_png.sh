...
#   - publication/create_forest_plots_restaurants_chosen_recolored.R       (T1 base A1-A5)
#   - publication/create_forest_plots_restaurants_chosen_recolored_adj.R   (T1 adj A1-A5)
#   - publication/create_customer_day_forest_plots_consolidated.R          (A5/A6 day, both tiers)
...
for sm in "" "TRUE"; do
  ...
  SORT_BY_MEAN="$sm" Rscript publication/create_forest_plots_restaurants_chosen_recolored.R
  echo "=== SORT_BY_MEAN='$sm' T1 adj ==="
  SORT_BY_MEAN="$sm" Rscript publication/create_forest_plots_restaurants_chosen_recolored_adj.R
